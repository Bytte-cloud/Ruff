# Local Development
Ruff is now powered by React, Typescript, and Tailwindcss using webpack at its core to generate compiled assets.
Release versions of Ruff will include pre-compiled, minified, and hashed assets ready-to-go.
...
The command above will download all of the dependencies necessary to get Ruff assets building. After that, its as
...
the asset URLs used in Ruff.

#### Development Environment
If you're using the [`Ruff/development`](https://github.com/Ruff/development) environments, which are

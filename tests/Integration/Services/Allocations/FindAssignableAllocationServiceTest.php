...
namespace Ruff\Tests\Integration\Services\Allocations;

use Ruff\Models\Allocation;
use Ruff\Tests\Integration\IntegrationTestCase;
use Ruff\Services\Allocations\FindAssignableAllocationService;
...
class FindAssignableAllocationServiceTest extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        config()->set('Ruff.client_features.allocations.enabled', true);
        config()->set('Ruff.client_features.allocations.range_start', 0);
        config()->set('Ruff.client_features.allocations.range_end', 0);
    }
    ...
    {
        $server = $this->createServerModel();
        config()->set('Ruff.client_features.allocations.range_start', 5000);
        config()->set('Ruff.client_features.allocations.range_end', 5005);
    ...
    public function testOnlyPortNotInUseIsCreated()
    {
        ...
        config()->set('Ruff.client_features.allocations.range_start', 5000);
        config()->set('Ruff.client_features.allocations.range_end', 5001);
    ...
    {
        $server = $this->createServerModel();
        config()->set('Ruff.client_features.allocations.range_start', 'hodor');
        config()->set('Ruff.client_features.allocations.range_end', 10);
        ...
        config()->set('Ruff.client_features.allocations.range_start', 10);
        config()->set('Ruff.client_features.allocations.range_end', 'hodor');
    ...
    {
        config()->set('Ruff.client_features.allocations.enabled', false);
        $server = $this->createServerModel();

...
return [
    ...
    */
    ...
    | standard Ruff shipped services.
    */
    ...
    */
    ...
    'cdn' => [
        'cache_time' => 60,
        'url' => 'https://cdn.Ruff.io/releases/latest.json',
    ],
    ...
    */
    ...
    'client_features' => [
        'databases' => [
            'enabled' => env('Ruff_CLIENT_DATABASES_ENABLED', true),
            'allow_random' => env('Ruff_CLIENT_DATABASES_ALLOW_RANDOM', true),
        ],

        'schedules' => [
            // The total number of tasks that can exist for any given schedule at once.
            'per_schedule_task_limit' => env('Ruff_PER_SCHEDULE_TASK_LIMIT', 10),
        ],

        'allocations' => [
            'enabled' => env('Ruff_CLIENT_ALLOCATIONS_ENABLED', false),
            'range_start' => env('Ruff_CLIENT_ALLOCATIONS_RANGE_START'),
            'range_end' => env('Ruff_CLIENT_ALLOCATIONS_RANGE_END'),
        ],
    ],
    ...
    */
    ...
    'files' => [
        'max_edit_size' => env('Ruff_FILES_MAX_EDIT_SIZE', 1024 * 1024 * 4),
    ],
    ...
    */
    ...
    'assets' => [
        'use_hash' => env('Ruff_USE_ASSET_HASH', false),
    ],
    ...
    */
    ...
    'email' => [
        ...
        'send_install_notification' => env('Ruff_SEND_INSTALL_NOTIFICATION', true),
        // Should an email be sent to a server owner whenever their server is reinstalled?
        'send_reinstall_notification' => env('Ruff_SEND_REINSTALL_NOTIFICATION', true),
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | This section controls the telemetry sent by Ruff.
    */

    'telemetry' => [
        'enabled' => env('Ruff_TELEMETRY_ENABLED', true),
    ],
];

...
use Ruff\Exceptions\Repository\DuplicateDatabaseNameException;
use Ruff\Exceptions\Service\Database\TooManyDatabasesException;
use Ruff\Exceptions\Service\Database\DatabaseClientFeatureNotEnabledException;
...
class DatabaseManagementService
{
     ...
     *
     * @see \Ruff\Services\Databases\DatabaseManagementService::generateUniqueDatabaseName()
     */
    ...
    {
        if (!config('Ruff.client_features.databases.enabled')) {

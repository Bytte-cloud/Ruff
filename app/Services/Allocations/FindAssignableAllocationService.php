...
class FindAssignableAllocationService
{
    ...
    {
        if (!config('Ruff.client_features.allocations.enabled')) {
    ...
    {
        $start = config('Ruff.client_features.allocations.range_start', null);
        $end = config('Ruff.client_features.allocations.range_end', null);

...
use Ruff\Repositories\Eloquent\RecoveryTokenRepository;
use Ruff\Exceptions\Service\User\TwoFactorAuthenticationTokenInvalid;
...
class ToggleTwoFactorService
{
    ...
    public function handle(User $user, string $token, ?bool $toggleState = null): array
    {
        ...
        $isValidToken = $this->google2FA->verifyKey($secret, $token, config()->get('Ruff.auth.2fa.window'));

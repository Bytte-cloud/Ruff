...
use Ruff\Transformers\Api\Client\ScheduleTransformer;
use Ruff\Http\Controllers\Api\Client\ClientApiController;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Ruff\Http\Requests\Api\Client\Servers\Schedules\ViewScheduleRequest;
use Ruff\Http\Requests\Api\Client\Servers\Schedules\StoreScheduleRequest;
use Ruff\Http\Requests\Api\Client\Servers\Schedules\DeleteScheduleRequest;
use Ruff\Http\Requests\Api\Client\Servers\Schedules\UpdateScheduleRequest;
use Ruff\Http\Requests\Api\Client\Servers\Schedules\TriggerScheduleRequest;
...
class ScheduleController extends ClientApiController
{
    ...
    public function update(UpdateScheduleRequest $request, Server $server, Schedule $schedule): array
    {
        ...
        //
        // @see https://github.com/Ruff/panel/issues/2425

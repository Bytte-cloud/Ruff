...
use Ruff\Exceptions\Http\Server\ServerStateConflictException;
 ...
 * @property \Illuminate\Database\Eloquent\Collection|\Ruff\Models\ActivityLog[] $activity
 * @property int|null $activity_count
 * @property Allocation|null $allocation
 * @property \Illuminate\Database\Eloquent\Collection|\Ruff\Models\Allocation[] $allocations
 * @property int|null $allocations_count
 * @property \Illuminate\Database\Eloquent\Collection|\Ruff\Models\Backup[] $backups
 * @property int|null $backups_count
 * @property \Illuminate\Database\Eloquent\Collection|\Ruff\Models\Database[] $databases
 ...
 * @property \Illuminate\Database\Eloquent\Collection|\Ruff\Models\Schedule[] $schedules
 * @property int|null $schedules_count
 * @property \Illuminate\Database\Eloquent\Collection|\Ruff\Models\Subuser[] $subusers
 * @property int|null $subusers_count
 * @property ServerTransfer|null $transfer
 * @property User $user
 * @property \Illuminate\Database\Eloquent\Collection|\Ruff\Models\EggVariable[] $variables
    ...
    public function variables(): HasMany
    {
        return $this->hasMany(EggVariable::class, 'egg_id', 'egg_id')
            ...
            ->leftJoin('server_variables', function (JoinClause $join) {
                ...
                //
                // @see https://github.com/Ruff/panel/issues/2250

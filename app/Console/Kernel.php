...
use Ruff\Services\Telemetry\TelemetryCollectionService;
use Ruff\Console\Commands\Schedule\ProcessRunnableCommand;
use Ruff\Console\Commands\Maintenance\PruneOrphanedBackupsCommand;
use Ruff\Console\Commands\Maintenance\CleanServiceBackupFilesCommand;
...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        if (config('Ruff.telemetry.enabled')) {

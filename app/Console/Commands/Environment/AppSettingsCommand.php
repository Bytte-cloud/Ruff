...
namespace Ruff\Console\Commands\Environment;
...
class AppSettingsCommand extends Command
{
     ...
     *
     * @throws \Ruff\Exceptions\RuffException
     */
    public function handle(): int
    {
        ...
        $this->variables['APP_SERVICE_AUTHOR'] = $this->option('author') ?? $this->ask(
            'Egg Author Email',
            config('Ruff.service.author', 'unknown@unknown.com')
        );
        ...
        $this->output->comment('Please reference https://Ruff.io/panel/1.0/additional_configuration.html#telemetry for more detailed information regarding telemetry data and collection.');
        $this->variables['Ruff_TELEMETRY_ENABLED'] = $this->option('telemetry') ?? $this->confirm(
            'Enable sending anonymous telemetry data?',
            config('Ruff.telemetry.enabled', true)
        ) ? 'true' : 'false';

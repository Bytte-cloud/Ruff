...
@section('content-header')
    <h1>Advanced Settings<small>Configure advanced settings for Ruff.</small></h1>
    <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="Ruff:guzzle:connect_timeout" value="{{ old('Ruff:guzzle:connect_timeout', config('Ruff.guzzle.connect_timeout')) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="Ruff:guzzle:timeout" value="{{ old('Ruff:guzzle:timeout', config('Ruff.guzzle.timeout')) }}">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label class="control-label">Status</label>
                                <div>
                                    <select class="form-control" name="Ruff:client_features:allocations:enabled">
                                        <option value="false">Disabled</option>
                                        <option value="true" @if(old('Ruff:client_features:allocations:enabled', config('Ruff.client_features.allocations.enabled'))) selected @endif>Enabled</option>
                                    </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="Ruff:client_features:allocations:range_start" value="{{ old('Ruff:client_features:allocations:range_start', config('Ruff.client_features.allocations.range_start')) }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="Ruff:client_features:allocations:range_end" value="{{ old('Ruff:client_features:allocations:range_end', config('Ruff.client_features.allocations.range_end')) }}">
